...
//  ParseStarterProject
//
//  Created by Jason Wong on 2015-08-25.
                                    ...
                                    if let objects = objects as? [PFObject] {
                                        ...
                                        for object in objects {
                                            ...
                                            if let driverLocation = object["driverLocation"] as? PFGeoPoint {
                                                ...
                                                var distanceMeters = userCLLocation.distanceFromLocation(driverCLLocation)
                                                ...
                                                var latDelta = abs(driverLocation.latitude - location.latitude) * 2 + 0.005
                                                
                                                var lonDelta = abs(driverLocation.longitude - location.longitude) * 2 + 0.005
